...
pub const comments = [_]Comment{
    ...
    .{ .func = "rmw_medium_single_field",                                    .text = "NOINLINE-PUB. Read-modify-write: field-aware detection proves the field changed -> in-place update + guaranteed publish." },
    .{ .func = "rmw_medium_two_fields",                                      .text = "NOINLINE-PUB. Read-modify-write: field-aware detection proves the field changed -> in-place update + guaranteed publish." },
    .{ .func = "double_rmw_struct",                                          .text = "NOINLINE-PUB. Two read-modify-writes, each a proven change -> guaranteed publish." },
