...
pub const ratings = [_]Rating{
    ...
    .{ .func = "pub_modify_struct_no_subs",                                         .speed = .near_optimal,                                   },
    .{ .func = "pub_modify_struct_with_subs",                                       .speed = .near_optimal,                                   },
    .{ .func = "pub_register",                                                      .speed = .near_optimal,                                   },
    .{ .func = "pub_runtime_write",                                                                                                           },
    .{ .func = "pub_write_no_subs",                                                                                                           },
    .{ .func = "pub_write_with_subs",                                               .speed = .near_optimal,                                   },
    .{ .func = "unpub_write_no_subs",                                                                                                         },
    .{ .func = "unpub_write_with_subs",                                             .speed = .near_optimal,                                   },
    .{ .func = "many_read_last",                                                                                                              },
