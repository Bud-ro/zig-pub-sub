...
pub fn build(b: *std.Build) void {
    ...
    const codegen_update_step = b.step("codegen-update", "Regenerate codegen/ assembly snapshots and sizes");
    const codegen_check_step = b.step("codegen-check", "Verify codegen/ snapshots are up-to-date (for CI)");
    ...
    for (modes, mode_names) |mode, mode_name| {
        ...
        // nm: extract byte sizes for codegen_ functions, sorted by size
