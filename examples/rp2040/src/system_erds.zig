//! ERD definitions for the RP2040 application.
//!
//! Defines the typed data fields available in the pub-sub system.
//! Each ERD has a unique 16-bit handle, a Zig type, an owning data
//! component index, and a subscription slot count.
...
/// Enum for referencing RP2040 ERDs by name.
...
/// Struct of all ERD field definitions for RP2040.
