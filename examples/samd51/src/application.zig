...
/// Advance the timer module by one tick and run all expired callbacks.
/// Called from the SysTick interrupt handler at 1 ms intervals.
pub fn tick() void {
